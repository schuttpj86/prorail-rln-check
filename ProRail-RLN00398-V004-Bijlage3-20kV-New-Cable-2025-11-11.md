---
title: "EMC studie 20kV New Cable"
...
Dit rapport geeft invulling aan **New Cable to be installed near De Schalm.**.

\pagebreak

## 2. Situatieomschrijving

New Cable to be installed near De Schalm.
...
- **Spoorweg:** Meteren Aansl. - Ressen = Bemmel
- **Geocode:** 155
- **Spoor km:** 55.6-88.5
...
|:------------|:---------------------|:-------------------------------------------------|
| **Initial** Bevindt hoogspanningsverbinding zich buiten zone | J | ≤24 kV buiten 31m zone. Gemeten afstand: 888.9 m - VOLDOET (geen verdere studie vereist) [zie Bijlage A] |
...
De gemeten minimale afstand tussen het tracé en het hart van het buitenste spoor bedraagt **888.9 m**.
