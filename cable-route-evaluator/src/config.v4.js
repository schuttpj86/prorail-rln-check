/**
 * RLN00398-V004 Configuration
 * Effective Date: TBD (Version 4)
 * 
 * This configuration implements the flowchart-based assessment approach
 * from Version 004 of the ProRail EMC standard.
 * 
 ...
 * - Additional updates in V004 (to be documented)
 */

export const configV4 = {
  // ============================================================================
  // ARCGIS & PRORAIL DATA SOURCES
  // ============================================================================
  ...
  prorail: {
    ...
    layers: {
      tracks: 6,        // Railway tracks (Spoortak)
      stations: 1,      // Railway stations
      technicalRooms: 9 // Technical rooms (EV Gebouwen)
    }
  },
  ...
  // Local storage keys
  storage: {
    projectKey: 'prorail-cable-routes-v4',
    settingsKey: 'prorail-settings-v4'
  },
  ...
  standard: {
    ...
    effectiveDate: 'TBD', // To be confirmed from V004 document
...
export const configV2 = configV4;
